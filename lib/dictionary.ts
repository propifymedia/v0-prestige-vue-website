...
export const dictionary = {
  ...
  nav: {
    ...
    quote: { fr: 'Soumission gratuite', en: 'Free Quote' },
  },
  ...
  whyChooseUs: {
    ...
    features: [
      ...
      {
        title: { fr: 'Service Personnalisé', en: 'Personalized Service' },
        description: {
          fr: 'Accompagnement sur mesure du début à la fin de votre projet.',
          en: 'Tailored support from start to finish of your project.',
        },
      },
      {
        title: { fr: 'Garantie de Qualité', en: 'Quality Guarantee' },
        description: {
          fr: 'Produits certifiés et garantis pour votre tranquillité d\'esprit.',
          en: 'Certified and guaranteed products for your peace of mind.',
        },
      },
    ],
  },
  ...
  // Gallery
  gallery: {
    title: { fr: 'Nos Réalisations', en: 'Our Projects' },
    subtitle: {
      fr: 'Découvrez quelques-uns de nos projets récents',
  ...
  testimonials: {
    ...
    items: [
      ...
      },
      {
        ...
        location: 'Laval, QC',
        quote: {
          fr: 'Installation rapide et soignée. Le prix était compétitif et la qualité est au rendez-vous. Je recommande Prestige Vue sans hésitation.',
          en: 'Quick and careful installation. The price was competitive and the quality is there. I recommend Prestige Vue without hesitation.',
        },
      },
      {
  ...
  // Quote Form
  quoteForm: {
    title: { fr: 'Demander une Soumission Gratuite', en: 'Request a Free Quote' },
    subtitle: {
  ...
  // Gallery Items (for lightbox captions)
  galleryItems: [
    {
      caption: {
    ...
    {
      caption: {
        fr: 'Projet résidentiel complet - Brossard',
        en: 'Complete Residential Project - Brossard',
      },
    },
  ],
} as const
